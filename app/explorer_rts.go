...
func (o *OKNO) explorerHandlerIndex(w http.ResponseWriter, r *http.Request) {
	tpl.TemplateHandler(cfg.Path+"/app/our/tpl").ExecuteTemplate(w, "index_gohtml", nil)
}

// HomeHandler handles a request for (?)
func (o *OKNO) explorerHandlerSection(w http.ResponseWriter, r *http.Request) {
	tpl.TemplateHandler(cfg.Path+"/sites/explorer_parallelcoin_info").ExecuteTemplate(w, "section_gohtml", mux.Vars(r)["section"])
}

// HomeHandler handles a request for (?)
func (o *OKNO) explorerHandlerItem(w http.ResponseWriter, r *http.Request) {
	data := struct {
		T    string
		Slug string
...
//	"net/http"
//
//	"github.com/oknors/okno/app/our/amp"
//	"github.com/oknors/okno/app/our/mod"
//	"github.com/gorilla/mux"
//)
//
